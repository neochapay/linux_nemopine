 ...
 */
static int sun6i_csi_link_subdev(struct sun6i_csi *csi,
				 ...
				 int link_flags)
{
	...
	src_pad = media_entity_get_fwnode_pad(source, sd->fwnode, MEDIA_PAD_FL_SOURCE);
	...
	ret = media_create_pad_link(source, src_pad, sink, sink_pad, link_flags);
